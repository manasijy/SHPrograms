...
lm.MaxIter= 100;
                %TIVmodel.Algorithm.SearchMethod.LMStartValue = 0.001;
                % TIVmodel.Algorithm.SearchMethod.LMStep = 10;
                % TIVmodel.Algorithm.SearchMethod.MaxBisections = 25;
                % TIVmodel.Algorithm.SearchMethod.RelImprovement = 1e-9;
...
TIVmodel.Algorithm.GradientOptions.DiffScheme = 'Central approximation';
                            % TIVmodel.EstimationInfo.DataTs = 0.0022;
                            %  TIVmodel.EstimationInfo.DataDomain = 'Time';
                            %  TIVmodel.EstimationInfo.DataInterSample = 'foh';
